...
public struct TCPHeader {
	[FieldOffset(0)] public ushort source_port;
	[FieldOffset(2)] public ushort destination_port;
	[FieldOffset(4)] public uint sequence_number;
	[FieldOffset(8)] public uint ack_number;
	[FieldOffset(12)] public byte dataoffset_ns;
	[FieldOffset(13)] public byte flags;
	[FieldOffset(14)] public ushort windowsize;
	[FieldOffset(16)] public ushort checksum;
	[FieldOffset(18)] public ushort urgent;
