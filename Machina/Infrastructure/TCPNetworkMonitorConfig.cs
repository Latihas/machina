...
public class TCPNetworkMonitorConfig {
    ...
    /// <summary>
    ///     Specifies the Process ID that is generating or receiving the traffic.  Either ProcessID, ProcessIDList, WindowName
    ///     or WindowClass must be specified.
    /// </summary>
    ...
    /// </summary>
    public ICollection<uint> ProcessIDList { get; set; } = new List<uint>();
    ...
    /// <summary>
    ///     Specifies the Window Name of the application that is generating or receiving the traffic.  Either ProcessID,
    ///     ProcessIDList, WindowName or WindowClass must be specified.
    /// </summary>
    public string WindowName { get; set; } = "";

    /// <summary>
    ///     Specifies the Window Class of the application that is generating or receiving the traffic.  Either ProcessID,
    ///     ProcessIDList, WindowName or WindowClass must be specified.
    /// </summary>
    ...
    /// </summary>
    public bool UseRemoteIpFilter { get; set; } = true;

    public class RPCapConf {
        /// <summary>
        ///     Specifies the host (e.g. "foo.bar.com") we want to connect to. It can be NULL in case we want to open an interface
        ///     on a local host.
        /// </summary>
        public string host { get; set; } = "";
        /// <summary>
        ///     Specifies the network port (e.g. "2002") we want to use for the RPCAP protocol. It can be NULL in case we want to
        ///     open an interface on a local host.
        /// </summary>
    ...
    /// </summary>
    public RPCapConf RPCap { get; set; } = new();
}